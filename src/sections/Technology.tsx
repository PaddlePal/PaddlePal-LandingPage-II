...
/* The software half of the section: three stages, following the data from the
   paddle to the app. Illustrations are line art on white, so they are composited
   with multiply and need no cut-out. */
const stages = [
  {
    img: dualcore,
  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-[1500px] px-6 sm:px-10">
        ...
        {/* --- software ---------------------------------------------------- */}
        <div className="mt-24 xl:mt-[17.5rem]">
          <h3
            className="reveal mx-auto mt-4 max-w-[20ch] text-center font-display text-[clamp(1.6rem,3.2vw,2.75rem)] leading-[1.08] font-medium tracking-[-0.04em] text-balance text-ink"
            data-visible={inView}
